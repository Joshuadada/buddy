...
const Header = ({ pageTitle, setSidebarStatus }: { pageTitle: string, setSidebarStatus: any }) => {
    ...
    return (
        <div className="flex items-center justify-between gap-2 py-2 md:py-4 lg:py-6 sticky top-0 bg-[#F8FAFC] z-40">
            ...
            <svg className="w-5 h-5 text-gray-800 cursor-pointer lg:hidden" onClick={() => setSidebarStatus(true)} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M10.83 5a3.001 3.001 0 0 0-5.66 0H4a1 1 0 1 0 0 2h1.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2h-9.17ZM4 11h9.17a3.001 3.001 0 0 1 5.66 0H20a1 1 0 1 1 0 2h-1.17a3.001 3.001 0 0 1-5.66 0H4a1 1 0 1 1 0-2Zm1.17 6H4a1 1 0 1 0 0 2h1.17a3.001 3.001 0 0 0 5.66 0H20a1 1 0 1 0 0-2h-9.17a3.001 3.001 0 0 0-5.66 0Z" />
                </svg>

                <h3 className="font-bold text-[#373B47] text-base sm:text-lg md:text-xl lg:text-2xl">{pageTitle}</h3>
            </div>
