...
const Sidebar = ({ className, navItems, setPageTitle, setSidebarStatus, sidebarStatus }: Properties) => {
    return (
        <>
            {/* Large screen */}
            <div className={'bg-white h-full flex-col justify-between gap-4 py-4 sm:py-5 md:py-6 2xl:py-7 hidden lg:flex ' + className}>
                <div>
            ...
            {/* Small screen */}
            <div className={`bg-white h-full flex flex-col justify-between gap-4 py-4 sm:py-5 md:py-6 2xl:py-7 transition-all absolute top-0 left-0 bottom-0 z-50 lg:hidden shadow-lg ${className} ${sidebarStatus ? 'ml-0' : '-ml-72'}`}>
                <div>
