...
import { EyesClosedIcon, EyesOpenIcon } from "@/assets/icons";
...
const formSchema = z.object({
  ...
  password: z
    ...
    .regex(/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.* ).{8,16}$/, {
      message:
        "Password must be 8-16 characters long, include a number, an uppercase and lowercase letter, and a special character",
    }),
});

export const SignupForm = () => {
  const { setStep, setEmail } = useSignUpContext();
  ...
  return (
    <div className="px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 pt-8 sm:pt-16 pb-8">
      <div className="bg-white border border-[#DDE2E4] shadow-lg max-w-[30rem] mx-auto rounded-md p-6 sm:p-8 md:p-10 lg:p-12">
        ...
        <p className="text-[#5B6871] text-xs md:text-sm mt-1 md:mt-2">
              ...
              <div>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <label
                        className="text-[#5B6871] text-[0.6rem] md:text-xs lg:test-sm"
                        htmlFor=""
                      >
                        First Name
                      </label>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        >
                          {showPassword ? <EyesClosedIcon /> : <EyesOpenIcon />}
                        </button>
                      </div>
                    </FormControl>
