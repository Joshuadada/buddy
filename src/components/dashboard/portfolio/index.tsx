        ...
        <div className="flex-1 flex flex-col gap-2 md:gap-3 lg:gap-4">
          <div className="grid gap-2 md:gap-3 lg:gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
            <div className="flex items-center gap-3 justify-between bg-white p-2 md:p-3 lg:p-4">
              <div>
                <h4 className="text-[#3B3B45] font-bold text-base sm:text-lg md:text-xl lg:text-2xl">
                  51
                </h4>
                <p className="text-[#A3A3A6] text-[0.5rem] md:text-[0.6rem] lg:text-xs">
                  Total Channels
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg md:rounded-xl lg:rounded-2xl p-2 md:p-4 lg:p-6">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <h4 className="text-[#3B3B45] font-bold tex-sm sm:text-base md:text-lg lg:text-xl">
                Overview
              </h4>
  
              <div className="flex gap-1 md:gap-2">
                <div className="text-[0.5rem] md:text-[0.6rem] lg:text-xs text-white bg-[#FF8600] rounded-md md:rounded-xl px-2 md:px-3 lg:px-4 py-0.5 md:py-1 lg:py-1.5">
                  Robbin Hood
                </div>
                <div className="text-[0.5rem] md:text-[0.6rem] lg:text-xs text-[#818187] bg-[#F6F6F6] rounded-md md:rounded-xl px-2 md:px-3 lg:px-4 py-0.5 md:py-1 lg:py-1.5">
                  Amreitrade
                </div>
                <div className="text-[0.5rem] md:text-[0.6rem] lg:text-xs text-[#818187] bg-[#F6F6F6] rounded-md md:rounded-xl px-2 md:px-3 lg:px-4 py-0.5 md:py-1 lg:py-1.5">
                  Fidelity
            ...
            <ChartContainer className="mt-2 md:mt-3 lg:mt-4" config={chartConfig}>
              <BarChart accessibilityLayer data={chartData}>
                ...
                <Bar
                  dataKey="robbinHood"
                  fill="var(--color-robbinHood)"
                  radius={4}
                />
                <Bar
                  dataKey="amreitrade"
                  fill="var(--color-amreitrade)"
                  radius={4}
                />
              </BarChart>
            </ChartContainer>
          ...
          <div className="bg-white rounded-lg md:rounded-xl lg:rounded-2xl p-2 md:p-4 lg:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 lg:gap-4 mt-2 md:mt-3 lg:mt-4">
              <div className="bg-white p-2 md:p-3 lg:p-4 border border-[#F1F1F1] rounded-md md:rounded-lg lg:rounded-xl">
                <h5 className="text-[#3B3B45] text-sm md:text-base lg:text-lg font-semibold">
                  8 Upcoming Influencer Marketing Trends and Benefits
                </h5>
                <p className="text-[#818187] font-light text-[0.6rem] md:text-xs lg:text-sm mt-1 md:mt-2">
                ...
                <div className="flex items-center gap-1 md:gap-2 lg:gap-3 mt-2 md:mt-3 lg:mt-4">
                  <div className="text-[#3B3B45] font-medium text-[0.6rem] md:text-xs lg:text-sm bg-[#F6F6F6] py-0.5 md:py-1 px-1.5 md:px-2.5 rounded-lg md:rounded-xl lg:rounded-2xl">
                    ❤️ 260
                  </div>
                  <div className="text-[#3B3B45] font-medium text-[0.6rem] md:text-xs lg:text-sm bg-[#F6F6F6] py-0.5 md:py-1 px-1.5 md:px-2.5 rounded-lg md:rounded-xl lg:rounded-2xl flex gap-0.5 md:gap-1 items-center">
                    ...
                    >
                      <g clipPath="url(#clip0_1_258)">
                        <path
                          d="M15 4.59207V11.344C15 12.4974 14.0749 13.4361 12.9378 13.4361H6.39514L2.0549 16.5V13.4361C0.921112 13.4322 0 12.4951 0 11.344V4.59207C0 3.43853 0.92514 2.5 2.06223 2.5H12.9378C14.0749 2.5 15 3.43853 15 4.59207Z"
                          fill="#FFB800"
                        />
                        <path
                          d="M16 4.6043V11.3957C16 12.5559 15.0135 13.5 13.801 13.5H8V2.5H13.801C15.0135 2.5 16 3.44402 16 4.6043Z"
                          fill="#FF8600"
                        />
                  ...
                  <div className="text-[#3B3B45] font-medium text-[0.6rem] md:text-xs lg:text-sm bg-[#F6F6F6] py-0.5 md:py-1 px-1.5 md:px-2.5 rounded-lg md:rounded-xl lg:rounded-2xl flex gap-0.5 md:gap-1 items-center">
                    ...
                    >
                      <g clipPath="url(#clip0_1_270)">
                        <path
                          d="M16 6.49746L8.75 0.5V4.16468C6.57562 4.27346 4.59781 5.13524 3.07469 6.49746C1.18844 8.18414 0 10.6376 0 13.3751V16.5H0.9375C0.9375 12.2774 4.37219 8.84181 8.59375 8.84181H8.75V12.4949L16 6.49746Z"
                          fill="#FF641A"
                        />
                        <path
                          d="M8.75 12.4959V8.84375H8.59375C4.37219 8.84375 0.9375 12.2784 0.9375 16.5H0V13.3759C0 10.6391 1.18844 8.18625 3.07469 6.5H16L8.75 12.4959Z"
                          fill="#F03800"
                        />
                      </g>
                      <defs>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-1 md:gap-2 mt-2 md:mt-3 lg:mt-4">
              <div className="bg-white p-2 md:p-3 lg:p-4 border border-[#F1F1F1] rounded-md md:rounded-lg lg:rounded-xl">
                ...
                <div className="text-center">
                  <h5 className="text-[#3B3B45] font-semibold text-[0.6rem] md:text-xs lg:text-sm">
                    Wanda Parker
                  </h5>
                  <p className="text-[#818187] text-[0.5rem] md:text-[0.6rem] lg:text-sm">
                    @ashking1234
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-1 md-gap-2 lg:gap-3 mt-2 md:mt-3 lg:mt-4">
              <div className="flex items-center justify-between gap-1 md:gap-2 bg-[#F6F6F6] px-2 md:px-3 lg:px-4 py-1 md:py-2 lg:py-3">
                <div>
                  <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                    <h4 className="text-[#3B3B45] font-semibold text-sm md:text-base lg:text-lg">
                      AAPL
                    </h4>
                    <svg
                      width="12"
              ...
              <div className="flex items-center justify-between gap-1 md:gap-2 bg-[#F6F6F6] px-2 md:px-3 lg:px-4 py-1 md:py-2 lg:py-3">
                <div>
                  ...
                  <p className="text-[#FF5252] font-medium text-[0.5rem] md:text-[0.6rem] text-xs">
                    -0.78%
                  </p>
                </div>
