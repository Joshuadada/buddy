...
export const AuthLayout = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 h-full overflow-auto items-center">
      <div className="bg-white h-full px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24 py-8 sm:py-12 md:py-14 lg:py-16 xl:py-20 hidden lg:block">
        ...
        <div className="flex flex-col gap-3 sm:gap-5 md:gap-7 lg:gap-9 mt-16 sm:mt-20 md:mt-24 lg:mt-28 xl:mt-32">
          <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
            ...
            <p className="text-[#5B6871] flex-1 text-sm md:text-base lg:text-lg">
        ...
        <p className="text-[#84919A] text-[0.6rem] md:text-xs lg:text-sm mt-12 sm:mt-14 md:mt-16 lg:mt-20 xl:mt-24">
