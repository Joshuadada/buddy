    ...
    return (
        <div className="px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 pt-8 sm:pt-16 md:pt-24 lg:pt-32 xl:pt-32 pb-8">
            <div className="bg-white border border-[#DDE2E4] shadow-lg max-w-[30rem] mx-auto rounded-md p-6 sm:p-8 md:p-10 lg:p-12">
                <svg width="76" height="61" className="mx-auto" viewBox="0 0 76 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h4 className="text-[#1D1D18] font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-center mt-2 sm:mt-3 md:mt-5 lg:mt- xl:mt-8">Email verified !</h4>

                <p className="text-[#5B6871] text-[0.6rem] md:text-xs lg:text-sm text-center mt-2">The verified email address will be associated with your account. Click on the button below to continue</p>
