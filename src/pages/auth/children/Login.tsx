    ...
    return (
        <div className="px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 pt-8 sm:pt-16 md:pt-24 lg:pt-32 xl:pt-32 pb-8">
            <div className="bg-white border border-[#DDE2E4] shadow-lg max-w-[30rem] mx-auto rounded-md p-6 sm:p-8 md:p-10 lg:p-12">
                <h5 className="text-[#1D1D18] font-bold text-base sm:text-lg md:text-xl lg:text-2xl">Log in to your account</h5>
                ...
                <p className="text-[#5B6871] text-xs md:text-sm md:p-1 lg:p-2 mt-4 sm:mt-6 md:mt-10 lg:mt-14 xl:mt-16">Don’t have an account? <span className="text-[#FF8600] cursor-pointer"><Link to={'/signup'}>Register</Link></span></p>
            </div>
